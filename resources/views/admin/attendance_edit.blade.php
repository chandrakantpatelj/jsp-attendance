            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fw-bold py-3 mb-0">Edit Attendance Record</h4>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.attendance.update', $attendance->id) }}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="time" name="punch_in_time" class="form-control" value="{{ $attendance->punch_in_time }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="time" name="punch_out_time" class="form-control" value="{{ $attendance->punch_out_time }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-9 offset-sm-3">
                                        ...
                                        <a href="{{ route('admin.attendance.index') }}" class="btn btn-secondary ms-2">
                                            Cancel
                                        </a>
                                    </div>
                                </div>
